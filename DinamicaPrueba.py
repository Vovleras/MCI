      ...
      #Caso restante
        ...
        if(cantCambiar==0):
          ...
          for k in range (0,cantCambiar+1):
            ...
            solParicial = encontrarSolucionParcial(matrizCI, matrizAgentes, i, posRef, esfuerzos, cIInicial, [0]*n)
            solParicial[i] = k
...
def encontrarSolucionParcial(matrizCI, matrizAgentes, n, esfuerzoMax, esfuerzos, cIInicial, solucion):
  #print("Entro a hallar solucion")
  j = esfuerzoMax
